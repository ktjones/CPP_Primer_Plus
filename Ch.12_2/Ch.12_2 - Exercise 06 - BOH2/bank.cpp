...
// reporting results
    if (customers > 0)
    {
		...
		cout << " average customers per hour: " << perhour << endl;
		cout << " average customers per hour: " << (double)customers/(double)hours << endl;
	}
    else
        cout << "No customers!\n";
    cout << "Done!\n";
