...
// setting things up
	...
	do 
	{
		...
		perhour = std::rand() % 120 + 1;    //  random initializing of rand()
		...
		for (int cycle = 0; cycle < cyclelimit; cycle++)
		{
			...
			cout << std::endl << std:: endl << "Wait Time 1: " << wait_time1  << std::endl;
			cout << std::endl << std:: endl << "Wait Time 2: " << wait_time1  << std::endl;
	...
	while (avg_wait_time > 0.9 && avg_wait_time < 1.1);
	...
	// reporting results
		...
		cout << endl << endl << "# of Simulation Loops: " << simcount << endl << endl;
	cout << "Done!\n";
